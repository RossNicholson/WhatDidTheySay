...
function WDTS_TitanPanel.Register()
    ...
    local L = LibStub and LibStub("AceLocale-3.0", true)
    
    -- Create Titan Panel plugin registry
    local TitanPlugin = {}
    TitanPlugin.registry = {
        id = "WDTS",
        ...
        version = "0.2.0",
        icon = "Interface\\Icons\\INV_Letter_01", -- Letter icon
        iconWidth = 16,
        savedVariables = {
            ShowLabelText = false,
            ShowIcon = true,
    ...
    -- Register the plugin
    TitanPanelButton_OnLoad(TitanPlugin)
