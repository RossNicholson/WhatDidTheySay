#!/usr/bin/env lua5.1
-- Test all German messages from the new guild chat log
...
local messages = {
    ...
    "sea mega nett",
    "ja kein stress",
    "und kann ihm einen kaufen ?",
    "oder bist du in IF Dea?",
    "ist jemand grad in IF und kann ihm einen kaufen? bekommt geld von mir zurück",
    "Dea musst halt kurz warten",
    "ja gehe gleich dahin",
}

print("New Guild Chat Review:\n")
print("=" .. string.rep("=", 70))
