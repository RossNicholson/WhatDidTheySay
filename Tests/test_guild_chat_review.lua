#!/usr/bin/env lua5.1
-- Test all German messages from the guild chat log
...
local messages = {
    "kann wer feuerverzauberung machen?",
    "im trade fenster gibt es unten einen slot, den man nicht traded - da packt man die zu verzaubernde waffe rein und nen enhcanter macht das dann",
    "ah lol das geht dann trd",
    "moin",
    "jemand im wald von elwynn und mag lvln?",
}

print("Guild Chat Review - All Messages:\n")
print("=" .. string.rep("=", 70))
