#!/usr/bin/env lua5.1
-- Test for guild recruitment message
...
-- Test message
local testMessage = "Die deutsche Gilde <Paragon> rekrutiert Mitstreiter ab Mindest Lvl 20 für gemeinsame Unternehmungen, wie Leveln, Dungeons und zukünftig raiden /w me"
print("=" .. string.rep("=", 70))
...
print("")
print("Expected: 'the German guild <Paragon> recruits comrades from minimum level 20 for common activities like leveling, dungeons and future raiding /w me'")
print("=" .. string.rep("=", 70))
