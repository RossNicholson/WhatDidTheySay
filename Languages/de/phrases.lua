...
WDTS_Lang_de_Phrases = {
    ...
    ["aufpassen"] = "watch out/be careful",
    ["auf machen"] = "open",
    ["zu machen"] = "close",
    ["an machen"] = "turn on",
    ["aus machen"] = "turn off",
